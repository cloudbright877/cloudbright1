...
export function ClosedTradesActivity({ trades }: ClosedTradesActivityProps) {
  return (
    <motion.div
      ...
      className="bg-gray-50 dark:bg-gradient-to-br dark:from-dark-800/95 dark:to-dark-900/95 border border-gray-200 dark:border-dark-700 rounded-2xl p-6 hover:border-primary-500/50 transition-all"
    >
      {/* Header */}
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-600 dark:text-dark-400">Last {trades.length} closed</p>
        </div>
      </div>
            ...
            >
              ...
              <div className="mb-2">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-normal text-gray-900 dark:text-white text-sm">{trade.pair}</span>
                ...
                <div className="flex items-center gap-1 text-xs text-gray-600 dark:text-dark-400">
              ...
              <div className="pt-2 border-t border-gray-200 dark:border-dark-700/50">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-500 dark:text-dark-500">P&L</span>
