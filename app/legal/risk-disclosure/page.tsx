...
Exchange and platform risks are significant in the cryptocurrency ecosystem. Exchanges and trading platforms, including Cloudbright, may experience technical outages, system failures, cyber attacks, software bugs, or other technical problems that prevent you from accessing your account, viewing your positions, or executing trades. During periods of high volatility and trading volume, platforms may become overloaded and unresponsive, potentially preventing you from managing your positions when it is most critical to do so.
...
Regulatory actions in major jurisdictions can have immediate and significant impacts on cryptocurrency prices and market liquidity. Announcements of potential regulatory crackdowns have historically caused sharp price declines, and actual implementation of restrictive regulations could result in even more severe market disruptions. Additionally, if Cloudbright or our service providers are required to comply with new regulations, we may need to modify our services, restrict access for users in certain jurisdictions, or cease operations entirely.
